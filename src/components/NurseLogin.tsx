...
import { Heart, Hash, Lock, ArrowLeft } from "lucide-react";
      ...
      <Card className="w-full max-w-md glass-card border-0 animate-fade-in-up">
        <CardHeader className="text-center pb-2 pt-8">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            Access patient care checklists
          </p>
        </CardHeader>
        ...
        <CardContent className="px-8 pt-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="nurseId" className="text-sm font-medium text-foreground">
                Nurse ID
              </Label>
            ...
            <p className="text-xs text-muted-foreground text-center px-4">
              Authorized access for nursing staff only.
            </p>

            <Button type="submit" variant="clinical" size="lg" className="w-full mt-2">
              Secure Login
            </Button>
          </form>
        </CardContent>
        ...
        <CardFooter className="pb-8 pt-4">
          <p className="text-xs text-muted-foreground text-center w-full">
            Clinical care system • Hospital-use prototype
          </p>
        </CardFooter>
      </Card>
    </div>
